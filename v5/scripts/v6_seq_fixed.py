...
- 加 no_repeat_ngram_size=3
- 输出到 /tmp/v6_results_fixed.jsonl
"""
...
OUT_JSONL = Path("/tmp/v6_results_fixed.jsonl")
...
def main():
    print("=== v6 复读修复版推理 ===")
    print("  repetition_penalty=1.5, no_repeat_ngram_size=3")
            ...
            with torch.no_grad():
                out = model.generate(
                    **inputs,
                    ...
                    repetition_penalty=1.5,  # 🔧 1.1 → 1.5
